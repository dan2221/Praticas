...
update locacoes set dataLocacao= dateadd (yy,5,datalocacao),dataretirada= dateadd (yy,5,dataretirada),dataentrega= dateadd (yy,7,dataentrega) ,datadevolucao= dateadd (yy,7,datadevolucao)
